...
public class ConfidenceInvalidMultiplicityErrorTranslator implements ModelStoreConfiguration {
	private final PartialRelation nodeType;
	private final ConfidencePartialRelation linkType;
	private final boolean inverse;
	private final Multiplicity multiplicity;

	public ConfidenceInvalidMultiplicityErrorTranslator(PartialRelation nodeType, ConfidencePartialRelation linkType,
