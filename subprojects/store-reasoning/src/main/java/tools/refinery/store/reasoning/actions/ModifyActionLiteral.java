...
public class ModifyActionLiteral<A extends AbstractValue<A, C>, C> extends AbstractActionLiteral {
	private final PartialSymbol<A, C> partialSymbol;
	private final List<NodeVariable> parameters;
	private final A value;

	public ModifyActionLiteral(PartialSymbol<A, C> partialSymbol, A value, List<NodeVariable> parameters) {
	...
	public BoundActionLiteral bindToModel(Model model) {
		...
		return tuple -> refiner.modify(tuple, value) ? Tuple.of() : null;
	}
}
