...
public class TransitionSystemBuilderImpl extends DesignSpaceExplorationBuilderImpl implements TransitionSystemBuilder {

	private final DnfLifter lifter = new DnfLifter();

	@Override
	public TransitionSystemBuilder transition(Rule rule) {
