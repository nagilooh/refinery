...
public class RailwayPackageImpl extends EPackageImpl implements RailwayPackage {
	...
	public static RailwayPackage init() {
		if (isInited) return (RailwayPackage) Registry.INSTANCE.getEPackage(RailwayPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRailwayPackage = Registry.INSTANCE.get(eNS_URI);
		...
		Registry.INSTANCE.put(RailwayPackage.eNS_URI, theRailwayPackage);
	 ...
	 * @generated
	 */
	public EAttribute getRoute_Active() {
	...
	public EAttribute getSwitchPosition_Position() {
		return (EAttribute)switchPositionEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getSwitchPosition_Route() {
		return (EReference)switchPositionEClass.getEStructuralFeatures().get(1);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRoute_Active(), ecorePackage.getEBoolean(), "active", null, 0, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRoute_Entry(), this.getSemaphore(), null, "entry", null, 0, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRoute_Exit(), this.getSemaphore(), null, "exit", null, 0, 1, Route.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSwitch_CurrentPosition(), this.getPosition(), "currentPosition", null, 0, 1, Switch.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSwitchPosition_Position(), this.getPosition(), "position", null, 0, 1, SwitchPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSwitchPosition_Route(), this.getRoute(), this.getRoute_Follows(), "route", null, 0, 1, SwitchPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSwitchPosition_Target(), this.getSwitch(), this.getSwitch_Positions(), "target", null, 0, 1, SwitchPosition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(semaphoreEClass, Semaphore.class, "Semaphore", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSemaphore_Signal(), this.getSignal(), "signal", null, 0, 1, Semaphore.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
