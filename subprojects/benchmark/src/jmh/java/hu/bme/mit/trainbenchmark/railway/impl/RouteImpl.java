 ...
 * </p>
 * <ul>
 *   <li>{@link RouteImpl#isActive <em>Active</em>}</li>
 *   <li>{@link RouteImpl#getFollows <em>Follows</em>}</li>
 *   <li>{@link RouteImpl#getRequires <em>Requires</em>}</li>
 *   <li>{@link RouteImpl#getEntry <em>Entry</em>}</li>
 *   <li>{@link RouteImpl#getExit <em>Exit</em>}</li>
 * </ul>
 *
 * @generated
 */
