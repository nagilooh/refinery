...
application {
	mainClass.set("tools.refinery.generator.manual.ManualExploration")
}

tasks.register<JavaExec>("man-expl") {
	...
	group = "Run"
	description = "Run the Refinery manual exploration application"
}
