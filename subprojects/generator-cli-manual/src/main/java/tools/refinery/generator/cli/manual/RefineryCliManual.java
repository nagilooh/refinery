 ...
 */
package tools.refinery.generator.cli.manual;

import com.beust.jcommander.JCommander;
import com.google.inject.Inject;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import tools.refinery.generator.cli.manual.commands.Command;
import tools.refinery.generator.cli.manual.commands.GenerateCommand;
import tools.refinery.generator.standalone.StandaloneRefinery;

import java.io.IOException;

public class RefineryCliManual {
	public static final int EXIT_SUCCESS = 0;
	public static final int EXIT_FAILURE = 1;
	public static final int EXIT_USAGE = 2;

	private static final Logger LOGGER = LoggerFactory.getLogger(RefineryCliManual.class);
	...
	public static void main(String[] args) {
		...
		RefineryCliManual cli = null;
		try {
			cli = StandaloneRefinery.getInjector().getInstance(RefineryCliManual.class);
		} catch (RuntimeException e) {
